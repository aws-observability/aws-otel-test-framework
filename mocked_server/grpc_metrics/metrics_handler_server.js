...
var PROTO_PATH = __dirname + '/metrichandler.proto';
...
var data_handler_proto = grpc.loadPackageDefinition(packageDefinition).opentelemetry.proto.collector.metrics.v1;
var get_data = ""
...
function main() {
    ...
    server.addService(data_handler_proto.MetricsService.service, {Export: Export, CheckData: CheckData});
