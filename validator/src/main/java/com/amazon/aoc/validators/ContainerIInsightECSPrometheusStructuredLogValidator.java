 ...
 */
@Log4j2
public class ContainerIInsightECSPrometheusStructuredLogValidator extends AbstractStructuredLogValidator {
    ...
    void init(Context context, FileConfig expectedDataTemplate) throws Exception {
        ...
        log.info("apps to validate {} schema to validate {}", validateApps.size(), schemasToValidate.keySet());
    }
