...
@Log4j2
public abstract class ContainerInsightStructuredLogValidatorBase extends AbstractStructuredLogValidator {
        ...
        for (String logType : schemasToValidate.keySet()) {
            ...
            try {
                log.info(String.format(
                        "[StructuredLogValidator] Filtering logs in log group %s" + " with filter pattern %s",
