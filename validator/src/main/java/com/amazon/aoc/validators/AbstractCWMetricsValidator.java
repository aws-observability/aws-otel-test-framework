...
/**
 * AbstractMetricsValidator is diverged from CWMetricValidator for container
 * insight metrics validation. In this validator, we exclude specific dimension
 * checking, e.g. OTelLib and metrics rolling up.
 */
