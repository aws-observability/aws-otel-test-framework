...
public class ContainerInsightPrometheusStructuredLogValidator
  ...
  /**
   * We need a bigger retry (12 instead of 6) because we have multiple tasks running on a single EC2
   * instance. It takes a while for the EC2 instance to register itself as ECS container instance.
   */
  ...
  void init(Context context, FileConfig expectedDataTemplate) throws Exception {
    logGroupName =
        String.format(
            "/aws/containerinsights/%s/prometheus",
