...
public class ConfigLoadHelper {
	 ...
	 * 
	 * @param filePath
	 *            the relative path under /resources/validations/
	 * @return a list of validationconfig object
	 * @throws IOException
	 *             when the filepath is not existed
	 */
	public List<ValidationConfig> loadConfigFromFile(String filePath) throws IOException {
		...
		List<ValidationConfig> validationConfigList = mapper.readValue(IOUtils.toString(getResourcePath(filePath)),
