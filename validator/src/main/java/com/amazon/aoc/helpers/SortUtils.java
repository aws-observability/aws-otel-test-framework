...
public final class SortUtils {
    ...
    /**
     * Given a list of entities, which are X-Ray segments or subsegments,
     * recursively sort each of their children subsegments by start time, then sort
     * the given list itself by start time.
     *
     * @param entities
     *            - list of X-Ray entities to sort recursively. Modified in place.
     */
