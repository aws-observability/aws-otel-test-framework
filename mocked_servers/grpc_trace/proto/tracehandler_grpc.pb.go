...
type TraceServiceClient interface {
	// Export data
	Export(ctx context.Context, in *Request, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error)
}
...
func (c *traceServiceClient) Export(ctx context.Context, in *Request, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error) {
...
type TraceServiceServer interface {
	// Export data
	Export(context.Context, *Request) (*ExportTraceServiceResponse, error)
...
func (UnimplementedTraceServiceServer) Export(context.Context, *Request) (*ExportTraceServiceResponse, error) {
...
func _TraceService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TraceServiceServer).Export(ctx, req.(*Request))
	}
...
var TraceService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc_trace/proto/tracehandler.proto",
}
